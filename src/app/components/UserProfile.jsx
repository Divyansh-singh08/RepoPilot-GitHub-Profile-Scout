    ...
    <>
        <Flex my={16} border={"2px solid"} borderColor={"green.500"} borderRadius={4} padding={8}>
            ...
            <VStack ml={8} alignItems={"self-start"}>
                {/* this is for the badges showing in flex--> side by side  */}
                <Flex gap={4}>
                ...
                {/* after badges i place text information of userProfile */}
                <Text fontSize={"2xl"} fontWeight={"bold"} mt={4} color={"green.480"}>
                    {userData.name}
                </Text>
